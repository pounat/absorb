        ...
        child: ListView(
          ...
          children: [
            ...
            _tipCard(cs, tt,
              ...
              title: l.tipsSheetTranscribeBookmarkTitle,
              desc: l.tipsSheetTranscribeBookmarkDesc,
            ),
            _tipCard(cs, tt,
              icon: Icons.manage_search_rounded,
              title: l.tipsSheetFindBetweenFormatsTitle,
              desc: l.tipsSheetFindBetweenFormatsDesc,
            ),
            _tipCard(cs, tt,
              icon: Icons.ios_share_rounded,
              title: l.tipsSheetShareQuoteTitle,
              desc: l.tipsSheetShareQuoteDesc,
            ),
            _tipCard(cs, tt,
              icon: Icons.content_cut_rounded,
              title: l.tipsSheetClipExportTitle,
              desc: l.tipsSheetClipExportDesc,
            ),
            _tipCard(cs, tt,
              icon: Icons.format_quote_rounded,
              title: l.tipsSheetAllHighlightsTitle,
              desc: l.tipsSheetAllHighlightsDesc,
            ),
            _tipCard(cs, tt,
              icon: Icons.volume_up_rounded,
              title: l.tipsSheetVolumeKeyPagesTitle,
              desc: l.tipsSheetVolumeKeyPagesDesc,
            ),
            _tipCard(cs, tt,
              icon: Icons.sync_rounded,
              title: l.tipsSheetSettingsSyncTitle,
              desc: l.tipsSheetSettingsSyncDesc,
            ),
            _tipCard(cs, tt,
              icon: Icons.ads_click_rounded,
              title: l.tipsSheetNavLongPressTitle,
              desc: l.tipsSheetNavLongPressDesc,
            ),
            _tipCard(cs, tt,

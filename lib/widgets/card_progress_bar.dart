...
class CardDualProgressBar extends StatefulWidget {
  ...
  final String? itemId;
  final bool compact;
  /// Show the book percentage (desktop now playing pane) in the time row.

        ...
        if (player == null) {
            ...
            RenderersFactory renderersFactory = new DefaultRenderersFactory(context) {
                ...
                protected AudioSink buildAudioSink(
                    ...
                    Log.i(TAG, "PATCH ACTIVE: buildAudioSink with SonicAudioProcessor + MonoProcessor + DeEsserProcessor + GainAudioProcessor, AudioTrack speed DISABLED");
                    return new DefaultAudioSink.Builder(context)
                        .setEnableFloatOutput(enableFloatOutput)
                        .setEnableAudioTrackPlaybackParams(false)
                        // De-ess before the loudness gain so the boost doesn't clip sibilance first.
                        .setAudioProcessors(new androidx.media3.common.audio.AudioProcessor[]{sonicAudioProcessor, monoProcessor, deEsserProcessor, new GainAudioProcessor()})
                        .build();
                }
            };
